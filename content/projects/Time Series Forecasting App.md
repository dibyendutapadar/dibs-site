...
**Key Features**
- Uses SARIMAX and Holt-Winters methods  
- Allows live parameter configuration  
- Provides real-time visualizations  

This app allows users to upload time series data and forecast using ARIMA and Holt-Winters (Triple Exponential Smoothing) methods. Navigate to the Forecast page to get started.
